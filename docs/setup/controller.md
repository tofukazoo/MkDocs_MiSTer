...
Skip any buttons you don't want to assign (there may be a lot of them) for now with the spacebar. If you accidentally assign the wrong button, don't worry, just define it all over again from the start.